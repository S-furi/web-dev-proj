    ...
    <div class="main">
        <div class="container">
            ...
            <div class="left">
                ...
                <!-- End of Sidebar -->
                <label for="create-post"><input type="button" value="Crea Post" id="create-post" class="btn btn-primary medium-btn" /></label>
                <label for="create-post"><input type="button" value="+" id="create-post" class="btn btn-primary small-btn" /></label>
            </div>
